...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("new ClientCrudService().getAllClients() = " + new ClientCrudService().getAllClients());

        System.out.println("new TicketCrudService().getTicketById(1) = " + new TicketCrudService().getTicketById(1));
        ...
        System.out.println("new PlanetCrudService().getAllPlanets() = " + new PlanetCrudService().getAllPlanets());
